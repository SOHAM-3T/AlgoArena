    ...
    <footer className="bg-slate-900 text-slate-300 py-12">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-white text-lg font-semibold mb-4">AlgoArena</h3>
            <p className="text-slate-400 mb-4">Empowering programmers through competitive coding challenges and community learning.</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-slate-400 hover:text-white transition-colors">Problem Archive</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-slate-400 hover:text-white transition-colors">Forums</a></li>
        ...
        <div className="mt-8 pt-8 border-t border-slate-800 text-center text-slate-400">
          <p>&copy; {new Date().getFullYear()} AlgoArena. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
